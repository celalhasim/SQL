...
==============================================================================*/   
 ...
 where marka_isim=isyeri ) AS alt_maas, (select max(maas) from calisanlar 
 where marka_isim=isyeri ) AS üst_maas 
 from markalar; 
 ...
 -----------------------------------------------------------------------------*/
 select marka_id, marka_isim, (select count(sehir) from calisanlar where marka_isim=isyeri) şehir_sayisi
 from markalar;
