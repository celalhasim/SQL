...
------------------------------------------------------------------------------*/   
select b.bolum_isim, p.personel_isim, p.maas, (select personel_isim from personel where p.mudur_id=personel_id) as mudur_ismi
from bolumler as b right join personel p
on p.bolum_id=b.bolum_id
